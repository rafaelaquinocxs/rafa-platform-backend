...
export const getEstatisticasPorMateria = async (req: Request, res: Response) => {
  try {
    // Em uma implementação real, buscaríamos do banco de dados com base no ID do usuário
    const userId = req.params.userId || '1';
...
export const getHistoricoSimulados = async (req: Request, res: Response) => {
  try {
    // Em uma implementação real, buscaríamos do banco de dados com base no ID do usuário
    const userId = req.params.userId || '1';
...
export const getAllEstatisticas = async (req: Request, res: Response) => {
  try {
    // Em uma implementação real, buscaríamos do banco de dados com base no ID do usuário
    const userId = req.params.userId || '1';
