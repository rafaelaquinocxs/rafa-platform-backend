...
const TransacaoSchema = new mongoose_1.default.Schema({
    userId: {
...
TransacaoSchema.methods.adicionarWebhookEvent = function (evento, payload) {
...
TransacaoSchema.methods.confirmarPagamento = function (dataPagamento, valorLiquido, taxaAsaas) {
...
TransacaoSchema.methods.receberPagamento = function (dataPagamento) {
...
TransacaoSchema.methods.processarReembolso = function (motivo) {
    this.status = 'refunded';
    this.observacoes = motivo;
    return this.save();
};
// Métodos estáticos
TransacaoSchema.statics.buscarPorUsuario = function (userId, limite = 10) {
...
TransacaoSchema.statics.relatorioFinanceiro = function (dataInicio, dataFim) {
...
exports.default = mongoose_1.default.model('Transacao', TransacaoSchema);
